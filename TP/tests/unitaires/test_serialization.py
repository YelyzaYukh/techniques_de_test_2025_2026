...
class TestPointSetErrorCases:
    ...
    def test_deserialize_truncated_data(self):
        ...
        with pytest.raises(ValueError, match="Inconsistent|tronqu|incomplet|invalid"):
...
class TestTrianglesEdgeCases:
    ...
    def test_shared_vertices(self):
        ...
        _assert_points_close(restored.vertices, triangles.vertices)
        assert restored.triangles == triangles.triangles
